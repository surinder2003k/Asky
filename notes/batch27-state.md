...
- Hidden Nvidia key live-tested: integrate.api.nvidia.com/v1/chat/completions with model "z-ai/glm-5.2" (bare slug, NO nvidia/ prefix) → HTTP 200 OK. Key: REDACTED
