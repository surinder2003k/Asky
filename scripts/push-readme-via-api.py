#!/usr/bin/env python3
"""Push README.md to GitHub branch `website` via Git Data REST API.

Builds a new tree from the CURRENT website tip tree (d4dc3dc), replacing the
README.md blob, commits on top of the current tip, and moves the ref.
"""
import json
import os
import time
